    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse">
        <ul class="nav navbar-nav">
          <li class="active"><a href="<?php echo ROOT_PATH ?>ger/usuario/lista_usuario.php">Usuário</a></li>
          <li><a href="<?php echo ROOT_PATH ?>ger/tutorial/lista_tutorial.php">Tutorial</a></li>
          <li><a href="<?php echo ROOT_PATH ?>ger/topico/lista_topico.php">Tópico</a></li>
